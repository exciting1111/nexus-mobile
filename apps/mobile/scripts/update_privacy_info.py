# from https://github.com/kimbely0320/update_privacy_info.py/blob/main/update_privacy_info.py
# run `python3 update_privacy_info.py ../ios` from `apps/mobile/scripts` to update PrivacyInfo.xcprivacy file
import argparse
import os
import datetime
